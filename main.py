import os
import telebot
bot = telebot.TeleBot("6754743684:AAEjvlkPgejbnZcUWfT1RyBRCbr848KVftM")
user_new_names = {}
@bot.message_handler(commands=['start'])
def send_welcome(message):
    bot.reply_to(message, f"""<b>Welcome to the file renamer bot. Send me a file to rename it. By @AIMBOTAXEE</b>""",parse_mode="HTML") 
